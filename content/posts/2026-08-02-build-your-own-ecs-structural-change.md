...
Same shape as the part 1 checkpoint, dropping into `src/main.rs` of a fresh project. Also available as a [gist](https://gist.github.com/matthewjberger/20fdef019ff97edc5ae60a961fcde6ab).
...
fn main() {
    ...
    let landmark = EntityBuilder::new()
